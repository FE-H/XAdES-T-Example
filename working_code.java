...
/*
	...
	public DSSDocument signDocument(String pathToDocument, String keystore, PasswordProtection password) throws Exception {
	    ...
	    //do an extend class id XPathTransform which would call this protected constructor
	    //DSSTransform t = new XPathTransform(ns, "http://www.w3.org/TR/1999/REC-xpath-19991116", "not(//ancestor-or-self::ext:UBLExtensions)");
	    parameters.setXPathLocationString("/Invoice ");
